...
const Header = () => {
  return (
    <header className="fixed top-6 left-1/2 transform -translate-x-1/2 z-50 animate-fade-in-up">
      <nav className="glass px-8 py-4 rounded-full flex items-center gap-8">
        ...
        <div className="flex items-center gap-6">
          ...
          <a href="/auth" className="text-foreground/80 hover:text-foreground transition-colors">
            Sign In
          </a>
        </div>
      </nav>
