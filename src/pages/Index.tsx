        ...
        <div className="max-w-7xl mx-auto text-center">
          ...
          <div className="overflow-hidden relative">
            <div className="flex animate-scroll space-x-8 md:space-x-12 lg:space-x-16">
              ...
              <div className="flex space-x-8 md:space-x-12 lg:space-x-16 shrink-0">
                <img src="/lovable-uploads/harvard-logo.png" alt="Harvard University" className="h-10 md:h-12 lg:h-16 grayscale opacity-60 hover:opacity-80 transition-opacity" onError={(e) => { e.currentTarget.src = "data:image/svg+xml;base64,"; }} />
                <img src="/lovable-uploads/nus-logo.png" alt="National University of Singapore" className="h-10 md:h-12 lg:h-16 grayscale opacity-60 hover:opacity-80 transition-opacity" onError={(e) => { e.currentTarget.src = "data:image/svg+xml;base64,"; }} />
                <img src="/lovable-uploads/iit-logo.png" alt="Indian Institute of Technology" className="h-10 md:h-12 lg:h-16 grayscale opacity-60 hover:opacity-80 transition-opacity" onError={(e) => { e.currentTarget.src = "data:image/svg+xml;base64,"; }} />
                <img src="/lovable-uploads/mit-logo.png" alt="Massachusetts Institute of Technology" className="h-10 md:h-12 lg:h-16 grayscale opacity-60 hover:opacity-80 transition-opacity" onError={(e) => { e.currentTarget.src = "data:image/svg+xml;base64,"; }} />
                <img src="/lovable-uploads/oxford-logo.png" alt="University of Oxford" className="h-10 md:h-12 lg:h-16 grayscale opacity-60 hover:opacity-80 transition-opacity" onError={(e) => { e.currentTarget.src = "data:image/svg+xml;base64,"; }} />
                <img src="/lovable-uploads/stanford-logo.png" alt="Stanford University" className="h-10 md:h-12 lg:h-16 grayscale opacity-60 hover:opacity-80 transition-opacity" onError={(e) => { e.currentTarget.src = "data:image/svg+xml;base64,"; }} />
              </div>
            </div>
          </div>
        </div>
